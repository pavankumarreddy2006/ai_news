...
export function HomePage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <StatsGrid
        stats={[
          { label: "Ranked AI stories", value: news.length, note: "Fresh AI updates cleaned and simplified." },
          { label: "Tracked AI tools", value: tools.length, note: "Searchable directory with AI rankings." },
